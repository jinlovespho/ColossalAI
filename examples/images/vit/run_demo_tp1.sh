...
--exp_name server05_gpu1_${dataset}_${model_name}${patch_size}_tp${tp_size}_lr${lr}_noOptimization \
...
CUDA_VISIBLE_DEVICES=0 torchrun ${DISTRIBUTED_ARGS} vit_train_demo.py ${TRAINING_ARGS} ${PARALLEL_ARGS} ${MODEL_ARGS} ${DATA_ARGS} ${WANDB_ARGS}
